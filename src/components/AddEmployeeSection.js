...
const AddEmployeeSection = ({ refreshEmployees }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Convert joiningDate to a Date object if it's not already one
        ...
        const formattedDate = joiningDate.toLocaleDateString('en-GB'); // This will format date as dd/MM/yyyy
        ...
        const requestData = {
            ...
            lastName: formData.lastName,
            designation: formData.designation,
            joiningDate: formattedDate, // Send the date in dd/MM/yyyy format
        };
